...
function adminPerfis(){
  ...
  const THRESHOLD = 10000; // valor padrão da dupla aprovação
  ...
  const perfis = [
    {
      ...
      aprovacao: `Nível 2 — apenas valores acima de ${formatMoney(THRESHOLD)}`,
      aprovacaoCor: '#856404',
      podeSubmeter: false,
      podeAprovar: true,
      nivelAprovacao: 2,
    ...
    <div class="box" style="margin-top:0;">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:20px;">
        ...
        <div style="background:#fff3cd;border:1px solid #ffc107;border-radius:12px;padding:16px;text-align:center;">
          ...
          <div style="font-size:12px;color:#856404;"><strong>Tesoureiro Distrital</strong> aprova ou rejeita. Se aprovado e valor ≤ ${formatMoney(THRESHOLD)}, fica <strong>Aprovado</strong>.</div>
        </div>
        <div style="background:#d4edda;border:1px solid #28a745;border-radius:12px;padding:16px;text-align:center;">
          ...
          <div style="font-size:12px;color:#155724;"><strong>Admin Geral</strong> — obrigatório apenas se valor > ${formatMoney(THRESHOLD)}</div>
        </div>
      </div>
  ...
  // Carregar utilizadores agrupados por perfil
